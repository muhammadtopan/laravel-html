  ...
  <div class="col-xl-2 col-lg-3 col-sm-6">
    <div class="card h-100">
      <div class="card-header pb-0">
        ...
        <span class="d-block mb-2">Sessions</span>
      </div>
      <div class="card-body">
        <div id="sessions"></div>
      </div>
  ...
  <div class="col-xl-2 col-lg-3 col-sm-6">
    <div class="card h-100">
      <div class="card-header pb-0">
        ...
        <span class="d-block mb-2">Overview</span>
      </div>
      <div class="card-body">
  ...
  <div class="col-xl-2 col-lg-3 col-sm-6">
    <div class="card h-100">
      <div class="card-header pb-0">
        ...
        <span class="d-block mb-2">Total Growth</span>
      </div>
      <div class="card-body">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide pb-3">
          ...
          <div class="d-flex align-items-center gap-2">
            <small class="text-body">Total $23.5k Earning</small>
            <div class="d-flex text-success">
    ...
    <div class="swiper-container swiper-container-horizontal swiper swiper-sales" id="swiper-marketing-sales">
      <div class="swiper-wrapper">
        <div class="swiper-slide pb-3">
          ...
          <div class="d-flex align-items-center gap-2">
            <small class="text-body">Total 245.8k Sales</small>
            <div class="d-flex text-success">
