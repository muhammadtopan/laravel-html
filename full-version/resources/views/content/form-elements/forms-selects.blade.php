    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6 mb-4">
            <div class="form-floating form-floating-outline">
              <input id="TagifyReadonly" class="form-control readonlyMix" readonly value='[{"value" : "tag1", "readonly" : true, "title" : "Non-editable Read-only tag"}, {"value" : "tag2","title" : "Editable read-only tag"},{"value" : "tag3","readonly" : true,"title" : "Another readonly tag"}]' />
