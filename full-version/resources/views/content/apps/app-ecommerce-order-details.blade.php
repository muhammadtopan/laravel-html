...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
  ...
  <div class="d-flex flex-column justify-content-center">
    <h5 class="mb-1 mt-3">Order #32543 <span class="badge bg-label-success me-2 ms-2 rounded-pill">Paid</span> <span class="badge bg-label-info rounded-pill">Ready to Pickup</span></h5>
        ...
        <div class="d-flex justify-content-start align-items-center mb-4">
          ...
          <div class="d-flex flex-column">
            <a href="{{url('app/user/view/account')}}">
              <h6 class="mb-1">Shamus Tuttle</h6>
            </a>
