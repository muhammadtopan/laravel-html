    ...
    <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
      ...
      <div class="sidebar-body px-4 pb-4">
        <div class="mt-4 mb-3 pt-2">
          ...
          <textarea id="chat-sidebar-left-user-about" class="form-control chat-sidebar-left-user-about mt-3" rows="3" maxlength="120">Dessert chocolate cake lemon drops jujubes.</textarea>
        </div>
        <div class="my-3">
      ...
      <div class="sidebar-header py-3 px-4 border-bottom">
        <div class="d-flex align-items-center me-3 me-lg-0">
          ...
          <div class="flex-grow-1 input-group input-group-merge rounded-pill">
            <span class="input-group-text" id="basic-addon-search31"><i class="mdi mdi-magnify lh-1 mdi-24px"></i></span>
        ...
        <ul class="list-unstyled chat-contact-list" id="chat-list">
          ...
          <li class="chat-contact-list-item active">
            <a class="d-flex align-items-center">
              ...
              <small class="mb-auto">30 Minutes</small>
            </a>
          </li>
          <li class="chat-contact-list-item">
            <a class="d-flex align-items-center">
              ...
              <small class="mb-auto">1 Day</small>
            </a>
          </li>
        </ul>
        <!-- Contacts -->
    ...
    <div class="col app-chat-sidebar-right app-sidebar overflow-hidden" id="app-chat-sidebar-right">
      ...
      <div class="sidebar-body px-4">
        <div class="my-4 pt-2">
          ...
          <p class="mb-0">It is a long established fact that a reader will be distracted by readable content.</p>
        </div>
        <div class="my-4">
