      ...
      <ul class="p-0 m-0">
        <li class="d-flex mb-3 flex-wrap">
          ...
          <div class="d-flex justify-content-between flex-grow-1">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-text-secondary dropdown-toggle p-2" data-bs-toggle="dropdown" aria-expanded="false"><span class="me-2 d-none d-sm-inline-block">Can Edit</span></button>
        ...
        <li class="d-flex flex-wrap mb-3">
          ...
          <div class="d-flex justify-content-between flex-grow-1">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-text-secondary dropdown-toggle p-2" data-bs-toggle="dropdown" aria-expanded="false"><span class="me-2 d-none d-sm-inline-block">Owner</span></button>
              <ul class="dropdown-menu dropdown-menu-end">
                <li>
                  <a class="dropdown-item" href="javascript:void(0);">Owner</a>
                </li>
        ...
        <li class="d-flex mb-3 flex-wrap">
          ...
          <div class="d-flex justify-content-between flex-grow-1">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-text-secondary dropdown-toggle p-2" data-bs-toggle="dropdown" aria-expanded="false"><span class="me-2 d-none d-sm-inline-block">Can Comment</span> </button>
              <ul class="dropdown-menu dropdown-menu-end">
                <li>
                  <a class="dropdown-item" href="javascript:void(0);">Owner</a>
                </li>
        ...
        <li class="d-flex mb-3 flex-wrap">
          ...
          <div class="d-flex justify-content-between flex-grow-1">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-text-secondary dropdown-toggle p-2" data-bs-toggle="dropdown" aria-expanded="false"><span class="me-2 d-none d-sm-inline-block">Can View</span></button>
              <ul class="dropdown-menu dropdown-menu-end">
                <li>
                  <a class="dropdown-item" href="javascript:void(0);">Owner</a>
                </li>
